...
const FigureModalView = ({children, hasOpenModal, FigureThumbController, FigureProductsController, handleCloseModal}) => {
	...
	return createPortal(
			<div className={` hidden ${hasOpenModal ? 'md:flex' : 'md:invisible'} fixed w-full min-h-screen left-0 top-0 bg-black z-40 flex justify-center items-center`}>
				<div className='
					absolute md:w-1/2 md:h-3/4 md-lg:w-1/3 flex flex-col z-[100]'>
